...
class HangmanPageTR extends StatefulWidget {
  final HangmanGame _engine;

  HangmanPageTR(this._engine);

  @override
  State<StatefulWidget> createState() => _HangmanPageTRState();
}

class _HangmanPageTRState extends State<HangmanPageTR> {
