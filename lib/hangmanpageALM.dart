...
const List<String> alphabet = const [
  ...
  'N', 'O', 'Ö','P', 'Q', 'R', 'S', 'T', 'U', 'Ü', 'V', 'W', 'X', 'Y', 'Z', 'Ä', 'ß'
];
...
class HangmanPageALM extends StatefulWidget {
  final HangmanGame _engine;

  HangmanPageALM(this._engine);

  @override
  State<StatefulWidget> createState() => _HangmanPageALMState();
}

class _HangmanPageALMState extends State<HangmanPageALM> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Center(child: Text('Das Blümchenspiel')),
      ),
      body: Center(
        child: Column(
